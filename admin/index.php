...
<head>
    ...
    <style>
      ...
      .main-panel{
          ...
          /* background:linear-gradient(120deg,#e0aaff,#c77dff,#4a4e69); */
...
<body>
    ...
    <div class="wrapper">
        <div class="sidebar" data-color="purple" data-image="assets/img/image9.jpg">
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="#" class="simple-text">
                     ...
                     <img src="assets/img/admin1.jpeg" style="width:200px;height:180px;border-radius:50%">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="card">
                                   ...
                                   <h1 class="hfonts">Hello Admin </h3>
